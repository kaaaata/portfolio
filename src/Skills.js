  ...
  constructor() {
    ...
    this.state = {
      skills: [
        ...
        { skill: 'JavaScript', image: 'js.png', specs: ['ES7', 'Node/Express.js', 'Mocha'] },
        { skill: 'Python', image: 'python.png', specs: ['Python 3', 'Django 2'] },
        { skill: 'React', image: 'react.png', specs: ['React 16', 'React/Redux', 'React Router 4'] },
        { skill: 'SQL', image: 'sql.png', specs: ['Postgres'] },
