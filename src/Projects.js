    ...
    this.state = {
      projects: [
        { name: 'BIG 2', image: 'big2.png', shade: 'green',
          github: 'https://github.com/kaaaata/big-2', url: null,
          tools: ['HTML', 'CSS', 'JavaScript', 'Django', 'Python 3', 'React', 'Redux', 'Sass'],
          blurb: 'Live Big 2 live 1v1, 1vAI, and AIvAI. Includes AI reinforcement learning script!' },
        { name: 'DAY LOGGER', image: 'day.png', shade: 'pink',
          github: 'https://github.com/kaaaata/day-logger', url: 'https://day-logger.herokuapp.com/',
          tools: ['HTML', 'CSS', 'JavaScript', 'React', 'Redux', 'Sass', 'Postgres', 'Node.js'],
        ...
        { name: 'JELLY', image: 'jelly.png', shade: 'blue',
          ...
          tools: ['HTML', 'CSS', 'JavaScript', 'React', 'Postgres', 'Node.js'],
        ...
        { name: 'QUIKKER', image: 'uber.jpg', shade: 'black',
          ...
          tools: ['JavaScript', 'Node.js', 'Mocha', 'New Relic', 'Siege'],
        ...
        { name: 'PORTFOLIO', image: 'portfolio.png', shade: 'purple',
          ...
          tools: ['HTML', 'CSS', 'JavaScript', 'React', 'Sass'],
          blurb: 'This website!' },
