    ...
    this.state = {
      projects: _.chunk([
        { name: 'THE HAPPINESS PROJECT', image: 'thp.png', shade: 'yellow',
          ...
          blurb: 'The Happiness Project shares stories of what makes people happy. In progress!' },
        { name: 'JELLY', image: 'jelly.png', shade: 'blue',
          github: 'https://github.com/kaaaata/jelly', url: 'https://jellyfishapp.herokuapp.com/',
          tools: ['HTML', 'CSS', 'JavaScript', 'React', 'PostgreSQL', 'ExpressJS', 'Axios'],
        ...
        { name: 'BIG 2', image: 'big2.png', shade: 'green',
          ...
          tools: ['HTML', 'CSS', 'JavaScript', 'PostgreSQL', 'ExpressJS', 'Axios', 'Lo-Dash'],
          blurb: 'Play against the AI in this Big 2 clone built with plain HTML/CSS/JS. Currently working on multiplayer.' },
        { name: 'BLOG', image: 'blog.png', shade: 'black',
          github: 'https://github.com/kaaaata/kaaaata.github.io', url: 'https://kaaaata.github.io',
          tools: ['HTML', 'CSS', 'JavaScript', 'React', 'XMLHttpRequest'],
          blurb: 'This is a blog I maintained while doing Hack Reactor\'s software engineering immersive.' },
